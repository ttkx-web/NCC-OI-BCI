...
"""Export a shared-50M multi-head Package with an optional Awakening head."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Export a self-contained shared-50M multi-head runtime package.")
...
def resolved_export_arguments(args: argparse.Namespace) -> dict[str, object]:
    ...
    return {
        ...
        "awakening_head": _path(args.awakening_head) if args.awakening_head else None,
...
def main() -> None:
    ...
    output = export_50m_multi_head_runtime_package(
        ...
        emotion_head=resolved["emotion_head"], awakening_head=resolved["awakening_head"], package_id=resolved["package_id"],
