...
_EXPORTS = {
    ...
    "DatasetSpec": (".dataset_registry", "DatasetSpec"),
    "DATASET_REGISTRY": (".dataset_registry", "DATASET_REGISTRY"),
    "AWAKENING_2S": (".dataset_registry", "AWAKENING_2S"),
    "get_dataset_spec": (".dataset_registry", "get_dataset_spec"),
